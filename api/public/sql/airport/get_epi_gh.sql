...
SELECT 
    ...
    ROUND(SUM(A.GAS + A.LIQUID+ A.CAR), 3) AS "fuel1",
    ROUND(SUM(A.ELEC + A.SF6 + A.SEWAGE + A.SCOPE3_1+ A.SCOPE3_2 + A.STEAM1 + A.STEAM2 + A.DEGU), 3) AS "fuel2",
    ROUND(SUM(A.TOT_EM_TCO2EQ), 3) AS "totalTco2e"
FROM
    (SELECT 
        A.BAS_YM,
